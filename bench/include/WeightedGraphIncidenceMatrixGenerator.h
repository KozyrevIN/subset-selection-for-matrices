#ifndef MAT_SUBSET_WEIGHTED_GRAPH_INCIDENCE_MATRIX_GENERATOR_H
#define MAT_SUBSET_WEIGHTED_GRAPH_INCIDENCE_MATRIX_GENERATOR_H
...
#endif // MAT_SUBSET_WEIGHTED_GRAPH_INCIDENCE_MATRIX_GENERATOR_H
