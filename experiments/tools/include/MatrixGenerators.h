#ifndef MAT_SUBSET_EXPERIMENTS_MATRIX_GENERATORS_H
#define MAT_SUBSET_EXPERIMENTS_MATRIX_GENERATORS_H
...
#include "MatrixGenerators/WeightedGraphIncidenceMatrixGenerator.h"

#endif // MAT_SUBSET_EXPERIMENTS_MATRIX_GENERATORS_H